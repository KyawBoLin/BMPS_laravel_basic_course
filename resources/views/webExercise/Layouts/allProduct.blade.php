                ...
                <div class="row">
                        ...
                        <div class="card mb-2 mx-1">
                            ...
                            <div class="single-product-card">
                                <a href="product-detail.html" class="text-decoration-none">
                                    <img src="{{url('webExercises/assets/images/products/Apples.webp')}}" class="" alt="">
                                </a>
                            </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                        <div class="card mb-2 mx-1">
                            <div class="single-product-card">
                                <a href="product-detail.html" class="text-decoration-none">
                                  <img src="{{url('webExercises/assets/images/products/BabySpinach.webp')}}" class="" alt="">
                                </a>
                            </div>
                            <div class="single-product-detail">
                                <div class="mb-2 single-product-amount">
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                        <div class="card mb-2 mx-1">
                            <div class="single-product-card">
                                <a href="product-detail.html" class="text-decoration-none">
                                   <img src="{{url('webExercises/assets/images/products/blueberries.webp')}}" class="" alt="">
                                </a>
                            </div>
                            <div class="single-product-detail">
                                <div class="mb-2 single-product-amount">
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                        <div class="card mb-2 mx-1">
                            <div class="single-product-card">
                                <a href="product-detail.html" class="text-decoration-none">
                                  <img src="{{url('webExercises/assets/images/products/BrusselsSprouts.webp')}}" class="" alt="">
                                </a>
                            </div>
                            <div class="single-product-detail">
                                <div class="mb-2 single-product-amount">
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                        <div class="card mb-2 mx-1">
                            <div class="single-product-card">
                                <a href="product-detail.html" class="text-decoration-none">
                                   <img src="{{url('webExercises/assets/images/products/clementines.webp')}}" class="" alt="">
                                </a>
                            </div>
                            <div class="single-product-detail">
                                <div class="mb-2 single-product-amount">
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                        <div class="card mb-2 mx-1">
                            <div class="single-product-card">
                                <a href="product-detail.html" class="text-decoration-none">
                                    <img src="{{url('webExercises/assets/images/products/Corn.webp')}}" class="" alt="">
                                </a>
                            </div>
                            <div class="single-product-detail">
                                <div class="mb-2 single-product-amount">
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                        <div class="card mb-2 mx-1">
                            <div class="single-product-card">
                                <a href="product-detail.html" class="text-decoration-none">
                                   <img src="{{url('webExercises/assets/images/products/Cucumber.webp')}}" class="" alt="">
                                </a>
                            </div>
                            <div class="single-product-detail">
                                <div class="mb-2 single-product-amount">
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                        <div class="card mb-2 mx-1">
                            <div class="single-product-card">
                                <a href="product-detail.html" class="text-decoration-none">
                                   <img src="{{url('webExercises/assets/images/products/Dates.webp')}}" class="" alt="">
                                </a>
                            </div>
                            <div class="single-product-detail">
                                <div class="mb-2 single-product-amount">
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                        <div class="card mb-2 mx-1">
                            <div class="single-product-card">
                                <a href="product-detail.html" class="text-decoration-none">
                                   <img src="{{url('webExercises/assets/images/products/FrenchGreenBeans.webp')}}" class="" alt="">
                                </a>
                            </div>
                            <div class="single-product-detail">
                                <div class="mb-2 single-product-amount">
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                        <div class="card mb-2 mx-1">
                            <div class="single-product-card">
                                <a href="product-detail.html" class="text-decoration-none">
                                    <img src="{{url('webExercises/assets/images/products/GreenBeans.webp')}}" class="" alt="">
                                </a>
                            </div>
                            <div class="single-product-detail">
                                <div class="mb-2 single-product-amount">
